...
public extension Networking {
    func request(_ requestConvertible: R) -> NetworkPromise {
...
public extension Networking {
    ...
    func authenticate(authorizationHeader: String) {
        customHeaders["Authorization"] = authorizationHeader
    }

    func authenticate(bearerToken: String) {
